            ...
            <div className="registerContainer">
                <div className="signin">
                    ...
                    <div className="signin__mid">
                        ...
                        <input className="signin__mid--input" value={user} onChange={e => setUser(e.target.value)} id="username" placeholder="Username" type="text" />
                    </div>
                    <div className="signin__mid">
                        <label className="signin__mid--before">Password</label>
                        <input className="signin__mid--input" id="pass" value={pass} onChange={e => setPass(e.target.value)} placeholder="Password" type="password" />
                    </div>
