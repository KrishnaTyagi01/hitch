            ...
            <div className="registerEvent_body">
                ...
                <div className="tickets">
                    ...
                    <div className="addTicket">
                        ...
                        <input value={currTicket.name} onChange={e => setCurrTicket({ ...currTicket, name: e.target.value })} placeholder="Name" type="text" />
                        <input value={currTicket.email} onChange={e => setCurrTicket({ ...currTicket, email: e.target.value })} placeholder="Email" type="text" />
                        <input value={currTicket.phone} onChange={e => setCurrTicket({ ...currTicket, phone: e.target.value })} placeholder="Phone" type="text" />
                        <input value={currTicket.gender} onChange={e => setCurrTicket({ ...currTicket, gender: e.target.value })} placeholder="gender" type="text" />
                        <div>{ }</div>
                    </div>
                    <button type="button" onClick={addCurrParticpant} className="addParticipantBtn">Add Another Participant</button>
                </div>
                <button type="button" onClick={sendReq} className="registerEventButton">Register For this Event</button>
            </div>
