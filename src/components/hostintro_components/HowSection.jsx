	...
	return (
		<div className='how'>
				...
				<div className='how__left--points'>
					<div className='how__left--point'>
						...
						<p className='how__left--text'>
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut risus tortor
							vitae sit porta molestie consequat facilisis.
						</p>
					</div>
					<div className='how__left--point'>
			...
			<div className='how__right'>
				<img src={image3} alt='person' className='how__right--img' />
			</div>
		</div>
	);
};
