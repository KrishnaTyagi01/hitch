							...
							<div className="filter__checkbox">
								<div className="filter__form" style={{ display: "flex", flexDirection: "column" }}>
									<label
										className="filter__form--span">
										Free Event ?
									<input checked={freeEvent} readOnly className="filter__checkbox--input" type="checkbox" value="greenEggs" />
							...
							<div className="filter__checkbox">
								<div className="filter__form" style={{ display: "flex", flexDirection: "column" }}>
									<label
										className="filter__form--span">
										Online Event ?
									<input checked={onlineEvent} readOnly className="filter__checkbox--input" type="checkbox" value="greenEggs" />
