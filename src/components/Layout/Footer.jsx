			...
			<div className='footer'>
				<div className='footer__upper'>
					...
					<div className='footer__upper--buttons'>
						<a href='#' className=' footer__upper--googlebtn'>
							<img src={GoogleBtn} alt='google btn' />
						</a>
						<a href='#' className=' footer__upper--applebtn'>
				...
				<div className='footer__mid'>
					<ul className='footer__mid--list'>
						...
						<li className='footer__mid--listitem'>
							<a href='#' className='footer__mid--listlink' href='#'>
								About Hitch
							</a>
						</li>
						<li className='footer__mid--listitem'>
				...
				<div className='footer__lower'>
					...
					<Link to='terms' className='footer__lower--text'>
