			...
			<div className="eventcardold">
				<div className="eventcardold__wrapper">
					...
					<div className="eventcardold__eventname">
						...
						<span className="eventcardold__eventname--tourname">
							Viva La Viva Tour
						</span>
						<span className="eventcardold__eventname--tourdate">
							{" "}
							Mumbai-2021
						</span>
					</div>
					...
					<div className="eventcardold__lower">
						...
						<div className="eventcardold__lower--time">
							<span className="eventcardold__lower--start">
								{" "}
								EVENT STARTS IN
							</span>
							<span className="eventcardold__lower--entrytime">
								01D: 08H: 30M: 25S
							</span>
						</div>
					</div>

					<button className="eventcardold__button">
